app.controller("IsabellaCateringWebAppController", function ($scope, $http, IsabellaCateringWebAppService) {
    ...
    $scope.authenticateAdminLoginCredentials = function () {
    ...
    function buildGroupedPayments(payments) {
        ...
        return Object.values(map).map(function (g) {
            ...
            var typeOrder = { 'Down Payment': 1, 'Full Payment': 2, 'Additional': 3 };
    ...
    $scope.getSummary = function () {
        var today = new Date();
        today.setHours(0, 0, 0, 0);
        var counts = { unpaid: 0, partial: 0, overdue: 0, 'Down Payment': 0, 'Full Payment': 0, 'Additional': 0 };
        ...
        $scope.getDuePaymentsFiltered().forEach(function (p) {
            ...
            else if (paid > 0 && paid < due) counts.partial++;
    ...
    $scope.computedCreatePaymentStatus = function () {
        ...
        return computeStatus($scope.createPayment.amountDue, $scope.createPayment.amountPaid);
    };
    ...
    $scope.submitCreatePayment = function () {
        ...
        IsabellaCateringWebAppService.addPaymentService({
            ...
            amountPaid: Number($scope.createPayment.amountPaid) || 0,
    ...
    $scope.computedPaymentStatus = function () {
        ...
        return computeStatus($scope.newPayment.amountDue, $scope.newPayment.amountPaid);
    };
    ...
    $scope.computedEditPaymentStatus = function () {
        ...
        return computeStatus($scope.editData.amountDue, $scope.editData.amountPaid);
    };
    ...
    $scope.submitEditPayment = function () {
        ...
        IsabellaCateringWebAppService.updatePaymentService({
            ...
            amountPaid: Number($scope.editData.amountPaid) || 0,
            paymentStatus: $scope.computedEditPaymentStatus(),
            dueDate: str
        }).then(function (res) {
            if (res.data.success) {
                Swal.fire({
    ...
    var COMPANY_ADDRESS = 'General Trias, Philippines';
    var COMPANY_CONTACT = 'isabellacateringandevent@gmail.com | 0917 711 1401';
            ...
            .then(function (res) {
                ...
                group.payments.forEach(function (p, i) {
                    ...
                    tableBody.push([
                        ...
                        { text: formatPHP(paid), style: rowStyle, alignment: 'center' },
                        { text: formatPHP(balance), style: rowStyle, alignment: 'center' },
                                ...
                                { text: '' },
                                {
                                    ...
                                    table: {
                                        ...
                                        body: [
                                            ...
                                            [{ text: 'Total Balance:', style: 'totalLabel' }, { text: formatPHP(totalBalance), style: 'totalValue', alignment: 'right' }],
                                        ]
                                    },
                                    layout: 'noBorders'
                                }
